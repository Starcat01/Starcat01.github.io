    ...
    <div class="card mt-5 mx-auto w-25">
        ...
        <div class="card-body">
            <form action="" method="post">
                <input type="number" name="num1" class="form-control my-1" placeholder="First Number">
                <input type="number" name="num2" class="form-control my-1" placeholder="Second Number">
